...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585000&appid=97ca00bd5ff0eeaaef7178e88735af19&units=imperial";
...
weekday[6] = "Saturday";
 ...
 const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585000&appid=97ca00bd5ff0eeaaef7178e88735af19&units=imperial";
    ...
    for (let i = 0; i < towns.length; i++ ) {
        ...
        if (towns[i].name == 'Fish Haven') { 
          ...
          for (let y = 0; y < towns[i].events.length; y++) {
            ...
            p.textContent = towns[i].events[y];
            console.log(p);
            div.appendChild(p);
          }
